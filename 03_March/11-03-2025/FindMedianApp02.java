//find Median from two array with Sum numbers
...
class Median{
	...
	void findMedian(){
		...
		if(mergedArray.length % 2 == 0){
			double result = (double)(mergedArray[index-1]+mergedArray[index])/2;
			System.out.println("\nMedian of given merged array = "+result);
		}else{
			System.out.println("\nMedian of given merged array = "+mergedArray[index]);
		}
	}
}
public class FindMedianApp02{
